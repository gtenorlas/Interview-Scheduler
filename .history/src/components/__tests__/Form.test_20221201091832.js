...
describe('Form', () => {
  ...
  const {getByText} = render(<Form student="George Lucas" interviewer={null} interviewers={interviewers} onClick={()=>onSave}/>);
...
const {queryByText} = render(<Form student='Lydia Miller-Jones' interviewer="George Lucas" interviewers={interviewers} onClick={()=>onSave}/>);

 ...
 */
  ...
  function reducer (state, action) {
    switch (action.type) {
      ...
      case SUBTRACT_SPOTS: {
        const days = getDays([...state.days],SUBTRACT_SPOTS, action.isNewAppointment, state.da);
        return {
          ...state,
          days
        }
      ...
      case ADD_SPOTS:
        return {
          ...state,
          days: getDays([[...state.days]],ADD_SPOTS)
        }
      default:
        throw new Error(
  ...
  return : days 
  */
  function getDays (stateDays, operation, isNewAppointment = false) {
    let days = null;
    console.log("state days",stateDays)
